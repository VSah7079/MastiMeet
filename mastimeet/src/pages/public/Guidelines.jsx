        ...
        <div className="space-y-8">
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-red-50 rounded-xl p-6 flex gap-4 border-l-4 border-red-500">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-blue-50 rounded-xl p-6 flex gap-4">
                <span className="text-5xl font-bold text-primary-500 w-12 text-center">1</span>
                <div>
              ...
              <div className="bg-blue-50 rounded-xl p-6 flex gap-4">
                <span className="text-5xl font-bold text-primary-500 w-12 text-center">2</span>
                <div>
              ...
              <div className="bg-blue-50 rounded-xl p-6 flex gap-4">
                <span className="text-5xl font-bold text-primary-500 w-12 text-center">3</span>
                <div>
              ...
              <div className="bg-blue-50 rounded-xl p-6 flex gap-4">
                <span className="text-5xl font-bold text-primary-500 w-12 text-center">4</span>
                <div>
          ...
          <section className="space-y-6">
            ...
            <p className="bg-blue-50 rounded-xl p-4 text-gray-300">
          ...
          <div className="bg-linear-to-r from-primary-50 to-secondary-50 rounded-2xl p-8 text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="#" className="bg-white text-primary-500 font-bold px-8 py-3 rounded-full border-2 border-primary-500 hover:shadow-lg transition-all">Report a Violation</a>
            </div>
          </div>
        </div>
        </div>
