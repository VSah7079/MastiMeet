  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="bg-gradient-to-r from-gray-800 to-primary-900/50 px-[5%] py-4 flex justify-between items-center border-b border-primary-500/20 shadow-lg">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="bg-gradient-to-r from-red-600 to-red-700 hover:shadow-lg px-4 py-2 rounded-lg transition-all hover:scale-105 font-semibold"
          >
            End Chat
          </button>
        </div>
      ...
      <div className="h-[calc(100vh-100px)] bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 overflow-hidden flex flex-col">
            ...
            <div className="lg:col-span-1 flex flex-col gap-3 md:gap-4">
              ...
              <div className="hidden lg:flex flex-col gap-2">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 py-3 rounded-full font-semibold transition-all transform hover:scale-105 shadow-lg"
                >
                  ⏭️ Next
                </button>
              </div>
        ...
        {isConnected && (
          <div className="lg:hidden bg-gradient-to-t from-gray-900 via-gray-900/80 to-transparent p-4 flex justify-center gap-3 flex-wrap">
            <button
              onClick={() => setIsMuted(!isMuted)}
            ...
            <button
              onClick={handleNextPartner}
              className="bg-gradient-to-r from-yellow-500 to-yellow-600 px-6 py-3 rounded-full font-semibold text-lg transition-all transform hover:scale-105 shadow-lg"
            >
              ⏭️ Next
            </button>
            <button
              onClick={handleEndChat}
              className="bg-gradient-to-r from-red-600 to-red-700 px-6 py-3 rounded-full font-semibold text-lg transition-all transform hover:scale-105 shadow-lg"
            >
              ❌ End
            </button>
          </div>
      ...
      {isConnected && (
        <button
          onClick={handleEndChat}
          className="hidden lg:fixed lg:bottom-24 lg:right-6 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 px-8 py-4 rounded-full font-semibold text-lg transition-all transform hover:scale-105 shadow-lg"
        >
          ❌ End Chat
        </button>
      )}
